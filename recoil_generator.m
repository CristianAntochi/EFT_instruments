...
Earrhigh=Table[N[ER*10^-6],{ER,100,1000,0.5}];
...
benchmarkExposure = 1 KilogramDay; (*  1250*278.87# 1.25ton* 278.87days in kilogram.days*)
    ...
    Do[
      If[idm,
        ...
        *)
        ...
        filename=extendedoutpath<>"/IDM_Xe"<>ToString[IsotopeA]<>"_"<>Tag<>"_"<>SRtag<>"_"<>titles[[i]][[p]]<>".dat";
        Print["  Writing file: "<>filename];
