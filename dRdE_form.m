...
Do[Do[Export["/home/cristian/EFT/EFT_tools/DMFormFactor_180403/EFTcoeffplotdata/Xe"<>ToString[IsotopeA]<>"/Xe"<>ToString[IsotopeA]<>"_"<>titles[[i]][[p]]<>".dat",plotdata[[i]][[p]],"Table"],{i,1,Nops}],{p,1,3}];
